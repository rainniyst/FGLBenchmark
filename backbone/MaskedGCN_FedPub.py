...
class MaskedGCN_FedPub(nn.Module):
    def __init__(self, input_dim , hidden_dim, output_dim, num_layers=2, dropout=0.5):
        ...
        self.n_dims = hidden_dim
        self.n_clss = output_dim
        
        
        self.conv1 = MaskedGCNConv(self.n_feat, self.n_dims, cached=False, l1=1e-3)
        self.conv2 = MaskedGCNConv(self.n_dims, self.n_dims, cached=False, l1=1e-3)
        self.clsif = MaskedLinear(self.n_dims, self.n_clss, l1=1e-3)
...
class MaskedGCNLinear(torch.nn.Module):
    ...
    def __deepcopy__(self, memo):
        out = MaskedGCNLinear(self.in_channels, self.out_channels, self.bias
